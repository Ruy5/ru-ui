<template>
  ...
  <div>
    <div v-for="(row, rowIndex) in data" :key="rowIndex" class="ru-body-line">
      <div v-for="(column, colIndex) in columns" :key="colIndex" class="ru-body-cell"
        :style="{width: (column.props.width ? column.props.width : 1 / widthTatol) * 100 + '%'}">
